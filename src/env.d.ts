...
declare var process: {
  env: {
    NG_APP_FIREBASE_PROJECTID: string;
    NG_APP_FIREBASE_APPID: string;
    NG_APP_FIREBASE_DATABASEURL: string;
    NG_APP_FIREBASE_STORAGEBUCKET: string;
    NG_APP_FIREBASE_APIKEY: string;
    NG_APP_FIREBASE_AUTHDOMAIN: string;
    NG_APP_FIREBASE_MESSAGINGSENDERID: string;
    NG_APP_FIREBASE_MEASUREMENTID: string;
    NG_APP_ENV: string;
    [key: string]: any;
  };
};
